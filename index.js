...
cardHeader.setAttribute("class","card-header text-center bg-black text-white")
...
btn.addEventListener('click',()=>{
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${country.name.common}&appid=57a85b994640d1875636255e7ff2d10c`)
    .then((response)=>{
         return response.json();
    })
    .catch(()=>{
